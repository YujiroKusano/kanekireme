...
exports.runRentStage = function(user_id, reqText, pertner_id, name)  {
  commondb.getStage(user_id, (stage) => {
    if(stage == 0) {
      console.log('Rent::stage情報不正: ' + reqText);
    } else if(stage == 1) {
      console.log('Rent::stage１:: stage2実行: ' + reqText);
      stage2(user_id, pertner_id, reqText, name);
    } else if(stage == 2) {
      console.log('Rent::stage2:: stage3実行: ' + reqText);
      stage3(user_id, reqText);
    } else if(stage == 3) {
      console.log('Rent::stage3:: stage4実行: ' + reqText);
      stage4(user_id, reqText);
    } else if(stage == 4) {
      console.log('Rent::stage4:: stage5実行: ' + reqText);
      stage5(user_id, reqText);
    } else if(stage == 5) {
      console.log('Rent::stage5:: stage6実行: ' + reqText);
